...
<body>
	...
	<%
		String transactionUserID = request.getParameter("userID");

	    Statement statement = connection.createStatement();
	    
	    String query5 = "SELECT * FROM users where id= " + transactionUserID;
	    ResultSet res5 = statement.executeQuery(query5);
	    
	    String name = "";
	    if(res5.next()){
	    	
	   		name = res5.getString("username");
	    }
	...
	<section style="display: flex; justify-content: space-between; align-items: center;  margin: 10px 40px">
		...
		<nav >
        	...
        	<a href="/pharamcy/UserProfile.jsp">Profile</a>
	...
	<table>
        ...
        <tbody style="background-color: #ebebeb;">
        	 <% 
        	 int count = 0;
        	 String query = "SELECT * FROM transactions where userID = " + transactionUserID;
    ...
    %>
            <tr>
                ...
                <td> <a href="/pharamcy/MedicineDetail.jsp?id=<%=medicineID%>&edit=false">Here</a></td>
            </tr>
            <%
        }
